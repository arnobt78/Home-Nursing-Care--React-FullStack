    ...
    <div className="py-12 xl:py-24 px-6 lg:px-12 xl:px-44 space-y-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-primary/90 text-justify">
          Pflege ist Vertrauenssache – und wir wissen, dass mit der Entscheidung
          für einen Pflegedienst viele Fragen verbunden sind. Deshalb haben wir
          für Sie die häufigsten Anliegen gesammelt und verständlich
          beantwortet.
        </p>
        <p className="text-primary/90 text-justify">
        ...
        <p className="text-primary/90 text-justify">
          ...
          Antworten auf Ihre wichtigsten Fragen geben. Selbstverständlich stehen
          wir Ihnen auch persönlich für eine individuelle Beratung zur Seite –
