    ...
    <div className="space-y-6 px-12">
      ...
      <div className="bg-gray-200 p-4 rounded-2xl shadow-2xl">
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="lg:w-2/3 justify-center">
            ...
            <p className="font-ephesis font-bold text-3xl text-green-700">
              Dr. med. Frank Kabs
            </p>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-secondary/30 p-4 rounded-2xl shadow-2xl text-center">
          ...
          <div className="bg-secondary/30 green-100 p-4 rounded-2xl shadow-2xl text-center">
            <h4 className="font-bold text-lg text-green-700">
      ...
      <div className="bg-transparent p-8 flex flex-col lg:flex-row items-center gap-8">
        {/* Left Side: Text */}
        <div className="lg:w-2/3 space-y-4">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-primary/90 list-disc pl-5">
            <li>Verabreichung von Medikamenten bzw. Medikamentengabe</li>
            <li>
              An- und Ausziehen von ärztlich verordneten Kompressionsstrümpfen
            </li>
            <li>Blutdruckmessung und Blutzuckermessung</li>
            <li>Zuckerkontrolle</li>
            <li>Injektionen s.c. und i.m.</li>
            <li>Wundverbände / Wundversorgung</li>
            <li>Katheterwechsel</li>
            <li>Portversorgung</li>
            <li>Stomabehandlung</li>
            <li>Postoperative Versorgung</li>
            <li>Sonderversorgung und Ernährung</li>
            <li>
              Anlegen und Wechseln von Wundverbänden oder stützenden und
              stabilisierenden Verbänden
            </li>
            <li>Anlegen oder Abnehmen eines Kompressionsverbandes</li>
            <li>Dekubitusbehandlung</li>
            <li>Drainagen</li>
            <li>Einläufe und Infusionen</li>
            <li>Inhalation</li>
          </ul>
        </div>

        {/* Right Side: Logo and Contact */}
        <div className="lg:w-1/3 bg-secondary/20 p-12 rounded-[5rem] shadow-md flex flex-col">
          ...
          <div className="relative py-10 flex justify-between">
            ...
            <img
              src={logoRound}
              alt="Logo"
              className="absolute -top-12 -right-12 w-36 h-36 object-contain"
            />
          </div>
          <p className="text-primary/90 mt-2">
